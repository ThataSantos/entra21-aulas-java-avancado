...
public class Aula08Alunos extends Aula {

	public Aula08Alunos(String titulo, ArrayList<String> assuntos) {
...
// ordenação com lambda jeito mais simples e facil
		...
		// comparação com coçections jeito mais completo de ordenar
